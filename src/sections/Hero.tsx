      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 lg:py-40">
        <div className="grid lg:grid-cols-2 gap-14 lg:gap-20 items-center">
          ...
          <div className="space-y-10">
            ...
            >
              Your adorable Moxi companion for Discord
            </motion.h1>
            ...
            >
              Create a vibrant community with the all-in-one anime bot. Currency,
              roleplay, music, and administration in one place. Simple, adorable,
          ...
          >
            ...
            >
              ...
              <div className="relative w-80 h-80 sm:w-[28rem] sm:h-[28rem] rounded-[2.5rem] overflow-hidden">
                <img
                  src="/moxi-hero.jpg"
                  alt="Moxi - Your adorable Moxi companion"
